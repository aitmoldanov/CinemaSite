                ...
                <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img class="d-block img-fluid" src="https://gameplay.cafe/wp-content/uploads/2019/01/Dragon-Trainer-3-Recensione-Cover.jpg" alt="First slide">
                            <div class="carousel-caption d-none d-md-block">
                                <h5>Dragon Trainer 3 (2019)</h5>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img class="d-block img-fluid" src="https://wallpapershome.ru/images/wallpapers/tachki-3-1920x1080-tachki-3-14170.jpg" alt="Second slide">
                            <div class="carousel-caption d-none d-md-block">
                                <h5>Cars 3 (2017)</h5>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img class="d-block img-fluid" src="https://wallpapershome.ru/images/wallpapers/angry-birds-movie-1920x1080-krasniy-bombochka-chak-luchshie-multfilmi-7081.jpg" alt="Third slide">
                            <div class="carousel-caption d-none d-md-block">
                                <h5>Angry Birds Movie (2016)</h5>
                            </div>
                        </div>
                    </div>
                        ...
                        Please contact with us if you have any questions. We are avalible 24h.
                            ...
                            <div class="ibox">
                                <div class="ibox-content">
                                    ...
                                    <hr>
                                    <div>
                                        <a href="#" class="product-name"> Films</a>
                                        <div class="small m-t-xs">
                                            Stream unlimited movies and TV shows on your phone, tablet, laptop, and TV without paying more.
                                        </div>
                                        <div class="m-t text-righ">

                                            <a href="{{ url('/film') }}" class="btn btn-xs btn-outline btn-primary">Info <i class="fa fa-info" aria-hidden="true"></i> </a>
                                        </div>
                                    </div>
                                    <hr>
                                    <div>
                                        ...
                                        <div class="m-t text-righ">
                                            ...
                                            <a href="{{ url('/serial') }}" class="btn btn-xs btn-outline btn-primary">Info <i class="fa fa-info" aria-hidden="true"></i> </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
