            ...
            <div class="col-lg-2" >
                <div>
                    ...
                    <div class="list-group">
                        <a href="{{url('/film')}}" class="list-group-item">Films</a>
                        <a href="{{url('/serial')}}" class="list-group-item" selected>Serials</a>
                ...
                <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img class="d-block img-fluid" src="https://multifandom.ru/pic/201502/1920x1080/multifandom.ru-529.jpg" alt="First slide">
                            <div class="carousel-caption d-none d-md-block">
                                <h5>Sherlok (2010)</h5>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img class="d-block img-fluid" src="https://wallpapercave.com/wp/wp3811656.jpg" alt="Second slide">
                            <div class="carousel-caption d-none d-md-block">
                                <h5>Money Heist (2017)</h5>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img class="d-block img-fluid" src="https://udipedia.net/wp-content/uploads/Igra-prestolov.jpg" alt="Third slide">
                            <div class="carousel-caption d-none d-md-block">
                        ...
                        Please contact with us if you have any questions. We are avalible 24h.
                            ...
                            <div class="ibox">
                                <div class="ibox-content">
                                    ...
                                    <hr>
                                    <div>
                                        <a href="#" class="product-name"> Cartoon</a>
                                        <div class="small m-t-xs">
